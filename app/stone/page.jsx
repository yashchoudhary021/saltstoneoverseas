            ...
            <section className="pt-0 pb-20 bg-[#eceff1]">
                <div className="max-w-7xl mx-auto px-6">
                    <p className="text-gray-600 text-lg leading-relaxed max-w-4xl">
                        SaltStone Overseas aims to deliver consistent stone export solutions by aligning material quality with international buyer expectations and disciplined execution.
                    </p>
                </div>
            </section>
